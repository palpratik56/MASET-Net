def preprocess():
    ...
    # optimizer = optim.Adam(model.parameters(), lr=0.0001, betas=(0.9, 0.98), weight_decay=0.0001)
    optimizer = optim.RAdam(model.parameters(), lr=0.0001, betas=(0.9, 0.98), weight_decay=0.0001)
